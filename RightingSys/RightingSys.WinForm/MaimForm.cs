...
namespace RightingSys.WinForm
{
    public partial class MainForm :DevExpress.XtraBars.Ribbon.RibbonForm,AppPublic.Interface.IMainForm
    {
        ...
        public void MdiShow(BaseForm frm, object FuncId, bool ReStart = false)
        {
            ...
            {
                //DBhelper.appPublic.ShowException(ex, this.Text);
        ...
        //    {
        //        MainForm.dtUserFunction = this.InitUserFunction(appSession._SystemId, appSession._UserId, appSession._DepartmentId);
        //    }
        ...
        public void ShowNoRight(string guidFuncId)
        {
           ...
           // appPublic.ShowMessage(MSG_TYPE.ALERT, string.Format(YSPOS.MainForm_NoRight_OneParameter, funcName), this.Text);
        }
        ...
        //    if (MainForm.dtUserFunction == null)
        //    {
        //        this.InitUserFunction(appSession._SystemId, appSession._UserId,appSession._DepartmentId);
        //    }
